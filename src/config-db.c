...
config_db_new (void)
{
  config_db        *buff =  malloc (sizeof(config_db));
...
config_db *
config_db_new_from_file (file* _file)
{
  config_db      *buff     =  config_db_new ();
  buff->b_file              =  _file;
...
config_db *
config_db_new_from_path (mstring path)
{
  file        *b_file   = file_new_from_name (path, "r");
  config_db  *b_config = config_db_new_from_file (b_file);
